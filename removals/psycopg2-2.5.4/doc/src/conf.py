...
# Add any paths that contain ui here, relative to this directory.
...
# Custom sidebar ui, maps document names to ui names.
#html_sidebars = {}

# Additional ui that should be rendered to pages, maps page names to
# ui names.
